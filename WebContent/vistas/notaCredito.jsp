...
<form class="container-fluid">
    	 <div class="card" style="width: auto; width: auto; margin-top:5px; padding-top: 5px;padding-left: 5px;padding-right: 5px;padding-bottom: 5px;">
			<div class="row col-sm-12" style="padding-bottom: 5px;">	
			    	 <h5>Filtros de consulta - Nota De Credito</h5>
			</div>
		<div class="row">
			<div class="col-sm-1">
		...
		<button type="submit" class="btn btn-success" id="#AbrirRegistroFactura"><i class="fa fa-plus"></i>Registrar Nota De Credito</button>
		</div>
